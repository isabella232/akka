...
public abstract class HttpCredentials {
    ...
    public static HttpCredentials create(String scheme, String token, Map<String, String> parameters) {
        return new akka.http.model.headers.GenericHttpCredentials(scheme, token, Util.convertMapToScala(parameters));
    }
