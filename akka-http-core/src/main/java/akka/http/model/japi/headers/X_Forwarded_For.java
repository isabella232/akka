...
public abstract class X_Forwarded_For extends akka.http.model.HttpHeader {
    ...
    public static X_Forwarded_For create(RemoteAddress... addresses) {
        return new akka.http.model.headers.X$minusForwarded$minusFor(akka.http.model.japi.Util.<RemoteAddress, akka.http.model.RemoteAddress>convertArray(addresses));
    }
}
