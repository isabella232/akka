...
import akka.http.model.japi.TransferEncoding;
...
public abstract class Transfer_Encoding extends akka.http.model.HttpHeader {
    ...
    public static Transfer_Encoding create(TransferEncoding... encodings) {
        return new akka.http.model.headers.Transfer$minusEncoding(akka.http.model.japi.Util.<TransferEncoding, akka.http.model.TransferEncoding>convertArray(encodings));
    }
}
