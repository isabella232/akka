...
public abstract class HttpChallenge {
    ...
    public static HttpChallenge create(String scheme, String realm, Map<String, String> parameters) {
        return new akka.http.model.headers.HttpChallenge(scheme, realm, Util.convertMapToScala(parameters));
    }
}