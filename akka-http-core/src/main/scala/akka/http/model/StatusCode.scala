...
sealed abstract class StatusCode extends LazyValueBytesRenderable with japi.StatusCode {
  def intValue: Int
...
object StatusCodes extends ObjectRegistry[Int, StatusCode] {
  ...
  val GatewayTimeout                = reg(e(504)("Gateway Timeout", "The server was acting as a gateway or proxy and did not receive a timely request from the upstream server."))
